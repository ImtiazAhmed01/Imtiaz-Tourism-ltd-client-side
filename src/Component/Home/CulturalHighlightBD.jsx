...
const CulturalHighlightBD = () => {
    const highlights = [
        ...
        },
        {
            id: 2,
            name: "Nakshi Kantha",
            image: "https://example.com/nakshi-kantha.jpg",
            description:
        ...
        },
        {
            id: 3,
            name: "Folk Music",
            image: "https://example.com/folk-music.jpg",
            description:
        ...
        <section className="p-8 bg-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {highlights.map((highlight) => (
                    <motion.div
                        key={highlight.id}
                        className="highlight-card bg-white rounded-lg shadow-lg overflow-hidden"
                    ...
                    >
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-gray-700 mt-2">{highlight.description}</p>
                        </div>
                    </motion.div>
                ))}
            </div>
